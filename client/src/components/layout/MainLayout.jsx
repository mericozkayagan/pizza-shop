      ...
      <footer className="bg-gray-800 text-white py-8 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-bold mb-4">Pizza Paradise</h3>
              <p className="text-gray-300 mb-4">Serving the best Italian cuisine since 1995. Made with love and only the freshest ingredients.</p>
